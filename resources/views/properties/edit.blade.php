<x-app-layout>
    ...
    <form method="POST" action="{{ route('properties.update', $property->id) }}" enctype="multipart/form-data">
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-md-6">
                <input type="text" value={{ $property->description }} id="description" name="description"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="text" value="{{ $property->location }}" id="location" name="location"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="text" value="{{ $property->floor }}" id="floor" name="floor"
                    class="form-control @error('floor') is-invalid @enderror" required autofocus>
                @error('floor')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-md-6">
                <select class="custom-select" name="type">
                    @foreach ($typologies as $typology)
                        <option value={{ $typology }} {{ $typology == $property->type ? 'selected' : '' }}>
                            {{ $typology }} </option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="number" value="{{ $property->bedrooms }}" id="bedrooms" name="bedrooms" max="99"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="number" value="{{ $property->bathrooms }}" id="bathrooms" name="bathrooms" max="99"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="number" value="{{ $property->price }}" id="price" name="price"
