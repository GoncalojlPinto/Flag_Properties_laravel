...
<body x-data="sidebar()" class="bg-gray-200 text-gray-700" @resize.window="handleResize()">
    <div class="xl:flex">
        <div x-show="isOpen()" class="fixed xl:static inset-0 flex bg-white bg-opacity-75 h-screen">
            <div @click.away="handleAway()" class="w-80 text-white bg-yellow-800 shadow">
                <div class="flex bg-yellow-900 content-between">
                    <div class="p-3 w-full">Flag Properties</div>
                    <a @click.prevent="handleClose()" class="p-3 hover:bg-yellow-500 flex-1 flex items-center" href="#">
                ...
                <a class="flex items-center w-full p-3 hover:bg-yellow-500" href="#">
                ...
                <a class="flex items-center w-full p-3 hover:bg-yellow-500" href="{{ url('admin/users/') }}"><svg
                        class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a class="flex items-center w-full p-3 hover:bg-yellow-500" href="#"><svg class="h-6 w-6 mr-3"
                ...
                <form method="POST" action="{{ route('logout') }}">
                    <a class="flex items-center w-full p-3 hover:bg-yellow-500" href="{{ route('logout') }}"
        ...
        <div>
            <nav class="text-yellow-700 bg-white flex">
                <div x-show="!isOpen()" class="flex">
                    <a x-show="!isOpen()" @click.prevent="handleOpen()" class="p-3 hover:bg-yellow-500 hover:text-white"
                        href="#">
            ...
            <main class="grid gap-4 p-4 md:grid-cols-2 lg:grid-cols-3">
                <div class="shadow-lg">
                    <div class="px-4 py-3 text-white bg-yellow-500">
                        Lorem Ipsum
                    </div>
