    ...
    <div class="max-w-7xl pl-0 ml-0  sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden ml-1 space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('offers.index')" :active="request()->routeIs('offers.index')">
                        {{ __('Propostas de Compra') }}
                    </x-nav-link>
                    @hasanyrole('user|agent')
                        <x-nav-link :href="route('offers.index')" :active="request()->routeIs('offers.index')">
                            {{ __('Os meus agendamenntos') }}
                        </x-nav-link>
                    @endhasanyrole
                    <x-nav-link :href="url('my_favorites')">{{ __('Favoritos') }} </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <x-nav-link href="{{ url('/about') }}" class="text-sm text-gray-700 dark:text-gray-500 pl-5">Sobre Nós
                </x-nav-link>
            </div>
